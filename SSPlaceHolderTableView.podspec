#
#  Be sure to run `pod spec lint SSPlaceHolderTableView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/simformsolutions/SSPlaceHolderTableView.git", :tag => "#{spec.version}" }
